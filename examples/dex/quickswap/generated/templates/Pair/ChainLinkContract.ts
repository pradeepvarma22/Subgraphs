...
export class ChainLinkContract extends ethereum.SmartContract {
  ...
  getRoundData(_roundId: BigInt): ChainLinkContract__getRoundDataResult {
    let result = super.call(
      "getRoundData",
  ...
  latestRoundData(): ChainLinkContract__latestRoundDataResult {
    let result = super.call(
      "latestRoundData",
  ...
  proposedLatestRoundData(): ChainLinkContract__proposedLatestRoundDataResult {
    let result = super.call(
